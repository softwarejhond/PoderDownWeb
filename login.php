...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($result['success']) {
            header('Location: perfil.php?login=success');
            exit;
        } else {
...
$pageTitle = 'Iniciar Sesión — Poder Down';
...
@media (max-width: 480px) {
    ...
    .auth-wrapper .blob:nth-child(1) { width: 220px; height: 220px; left: -80px; }
    .auth-wrapper .blob:nth-child(2) { width: 200px; height: 200px; right: -70px; }
}
</style>
...
<div class="auth-wrapper">
    ...
    <div style="z-index:1;width:100%;max-width:440px;">
        ...
        <div class="auth-card">
            ...
            <?php if (isset($error)): ?>
            <div class="error-message"><i class="bi bi-exclamation-triangle me-1"></i> <?= htmlspecialchars($error) ?></div>
            <?php endif; ?>
            ...
            <form method="POST" novalidate autocomplete="off">
                ...
                <div class="input-group-cami">
                    ...
                    <input type="password" name="password" id="loginPassword" placeholder="Contraseña" required autocomplete="current-password">
                    <button type="button" class="toggle-password" onclick="togglePass('loginPassword', this)" aria-label="Mostrar contraseña">
                        <i class="bi bi-eye"></i>
                    </button>
                </div>
...
if (urlParams.get('registered') === '1') {
    Swal.fire({
        ...
        text: 'Tu cuenta fue creada. Inicia sesión.',
